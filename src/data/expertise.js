export const expertise = [
  ...
  },
  {
    ...
    points: {
      it: [['API e dati', 'Matchday collega un sito React e un backoffice Angular a un’API Express con PostgreSQL. qrinventory usa FastAPI e SQLModel per oggetti, posizioni ed etichette QR.'], ['Database e ORM', 'Uso PostgreSQL, NeonDB, MySQL e Drizzle ORM per organizzare i dati e collegarli alle applicazioni. Learning Vault usa SQLite con Drizzle per conservare i materiali di studio.'], ['Test e distribuzione', 'Uso Vercel per pubblicare i progetti web e GitHub Actions per pipeline CI/CD. qrinventory include test automatici, Docker e configurazione Azure tramite Terraform e GitHub Actions; Matchday esegue i controlli in GitLab CI ed è pubblicato su Vercel con Neon.']],
      en: [['APIs and data', 'Matchday connects a React site and an Angular back-office to an Express API with PostgreSQL. qrinventory uses FastAPI and SQLModel for items, locations and QR labels.'], ['Databases and ORMs', 'I use PostgreSQL, NeonDB, MySQL and Drizzle ORM to organise data and connect it to applications. Learning Vault uses SQLite with Drizzle to store study materials.'], ['Tests and deployment', 'I use Vercel to deploy web projects and GitHub Actions for CI/CD pipelines. qrinventory includes automated tests, Docker and Azure configuration through Terraform and GitHub Actions; Matchday runs checks in GitLab CI and is deployed on Vercel with Neon.']],
    },
